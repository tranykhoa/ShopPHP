                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <form action="index.php?action=shop" method="post">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="keyw" placeholder="Search by name">
                                    <div class="input-group-append">
                                        <button style="background-color: transparent;outline: none;" class="input-group-text bg-transparent text-primary">
                            ...
                            <div class="dropdown ml-4">
                                <form action="index.php?action=shop" method="post">
                                    <select name="idcg" onchange="this.form.submit()" class="border text-center">
                                        <option value="0">Story by</option>
                      ...
                      <form action="index.php?action=addtocart" method="post" >
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                ...
                                <a href="<?=$details?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>  
                            </div>
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="col-12 pb-1">
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center mb-3">
                            ...
                            <!-- <li class="page-item"><a class="page-link" href="index.php?action=shop&page=">  </a></li> -->
