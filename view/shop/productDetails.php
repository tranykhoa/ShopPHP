    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            <?php
              if(isset($hinhoneproduct)&&is_array($oneproduct)){
                extract($oneproduct);
              }
              // $hinh = $img_path.$img;
            ?>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold"><?=$namep?></h3>
